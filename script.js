...
// ================================================
// ================================================
// NAVBAR FUNCTIONALITY - FIXED FOR MOBILE
// ================================================
function initNavbar() {
    ...
    function toggleMenu(show) {
        if (show) {
            ...
            // Close menu
            mobileMenuContent.style.transform = 'translateY(-20px)';
...
function initGSAP() {
    ...
    onEnter: batch => {
        batch.forEach(el => {
            const originalValue = el.getAttribute('data-target');

            // Ambil angka dan simbol setelah angka, misalnya:
            // "1000+" → 1000 dan "+"
            // "500+"  → 500 dan "+"
            // "1000"  → 1000 dan ""
